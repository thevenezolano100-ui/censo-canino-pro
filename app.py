...
def inicio():
    if request.method == 'POST':
        ...
        nuevo = Canino(
            ...
            latitud=lat, longitud=lon, situacion=request.form.get('situacion', 'Censo Normal'), reportado_por=current_user.nombre, cubiculo_jaula=request.form.get('cubiculo_jaula', 'N/A'),
